...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/terraform: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/terraform ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/Firebomb.o: Firebomb.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Firebomb.o Firebomb.cpp

${OBJECTDIR}/Flame.o: Flame.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Flame.o Flame.cpp
...
${OBJECTDIR}/MeshTriangle.o: MeshTriangle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MeshTriangle.o MeshTriangle.cpp
...
${OBJECTDIR}/WaterBalloon.o: WaterBalloon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/WaterBalloon.o WaterBalloon.cpp
...
${OBJECTDIR}/GLScreenCapturer.o: GLScreenCapturer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GLScreenCapturer.o GLScreenCapturer.cpp

${OBJECTDIR}/ParticleMachine.o: ParticleMachine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ParticleMachine.o ParticleMachine.cpp
